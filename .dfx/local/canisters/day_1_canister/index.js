...
import { idlFactory } from './day_1_canister.did.js';
export { idlFactory } from './day_1_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAY_1_CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./day_1_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the day_1_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./day_1_canister.did.js")._SERVICE>}
 */
export const day_1_canister = createActor(canisterId);
